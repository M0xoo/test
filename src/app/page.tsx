        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://github.com/openboardLabs/openboard" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-[13px] text-[#8c8c8c] transition-colors hover:text-white">
              ...
              <span className="flex items-center gap-1 rounded-[4px] border border-[#333] bg-[#141414] px-2 py-0.5 text-[11px] font-medium">
                <svg height="12" viewBox="0 0 16 16" version="1.1" width="12" aria-hidden="true" fill="currentColor"><path d="M8 .25a.75.75 0 0 1 .673.418l1.882 3.815 4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97.719 4.192a.75.75 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25Z"></path></svg>
                420
              </span>
            </a>
          </div>
